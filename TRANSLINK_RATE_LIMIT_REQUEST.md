...
**Subject:** API rate limit increase request — BusPulse Vancouver (registered app)

Hello TransLink Open API team,

I'm the developer of **BusPulse Vancouver**, an iOS app that shows riders real-time
